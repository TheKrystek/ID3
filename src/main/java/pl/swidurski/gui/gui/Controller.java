...
import lombok.Data;
import pl.swidurski.gui.gui.tree.*;
import pl.swidurski.gui.id3.CSVReader;
import pl.swidurski.gui.id3.ID3;
import pl.swidurski.gui.model.Attribute;
import pl.swidurski.gui.model.DataSet;
import pl.swidurski.gui.model.Entry;
import pl.swidurski.gui.model.TreeNode;
...
public class Controller {
    ...
    private void addTreeNodeHandler(Graph<TreeNode> graph) {
        pl.swidurski.gui.gui.tree.Cell.Action<TreeNode> action = value -> showInfo(value);

        for (pl.swidurski.gui.gui.tree.Cell<TreeNode> cell : graph.getModel().getAllCells()) {
